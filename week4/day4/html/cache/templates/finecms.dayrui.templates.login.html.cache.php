...
<head>
	...
	<link href="<?php echo THEME_PATH; ?>admin/pages/css/login-3.min.css" rel="stylesheet" type="text/css" />
...
<div class="logo login-logo">
	<a href="<?php echo SITE_URL; ?>"><img src="<?php echo THEME_PATH; ?>logo.png" /></a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
